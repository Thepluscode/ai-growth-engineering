# `EXP-ACQ-0001` — Batch 03 Qualification

Date qualified: 2026-08-19

Purpose: create the third controlled 10-account research batch while earlier sends gather replies.
Qualification is not a diagnosis, send authorisation, or evidence that a funnel leak exists.
...
- **Observed fit:** UK SME-focused managed IT group with a dedicated Air Sec cyber division spanning
  MDR, SIEM/SOC, vulnerability management, Cyber Essentials and related services.
- **Observed route/proof:** repeated “Get in touch” and free-consultation routes,
  `enquiries@airit.co.uk`, eight UK offices, recognised frameworks and public customer evidence.
- **Buyer route:** use the published new-enquiries address and request routing to the commercial owner
  for managed cyber; do not infer an executive identity from outdated materials.
- **Research hypothesis:** determine whether service intent survives the generic consultation handoff.
- **Sources:** [cyber security](https://www.airit.co.uk/services/cyber-security/), [Cyber Essentials](https://www.airit.co.uk/wp-content/uploads/2021/09/05609-AirIT-Cyber-Essentials-Datasheet-02_single_pages.pdf)

## 2. BCN Group

- **Observed fit:** UK Microsoft-focused technology partner serving medium-sized organisations across
...
- **Observed fit:** UK managed IT and cybersecurity provider with totalIT service tiers, secure+,
...
- **Sources:** [managed cybersecurity](https://www.ramsac.com/managed-cybersecurity-services/), [people](https://www.ramsac.com/about-us/our-people/), [about](https://www.ramsac.com/about-us/)

## 5. Quiss

- **Observed fit:** privately owned UK MSP serving legal and professional-services firms with managed
...
- **Observed fit:** UK managed IT, cyber, communications, connectivity and mobile provider serving
...
- **Observed fit:** UK MSP/MSSP providing managed IT, co-managed IT, cloud, infrastructure,
...
- **Sources:** [Cyber Resilience Score](https://www.normcyber.com/how-it-works/cyber-resilience-score/), [Focal Analyst](https://www.normcyber.com/how-it-works/focal-analyst/), [contact](https://www.normcyber.com/contact-us/)

## 9. Cyber Tec Security
...
- **Observed fit:** UK cybersecurity risk-management provider serving professional-services and other
...
- **Observed:** `bulletproof.co.uk` redirects to a WorkNest Secure page describing the consolidated
  Pentest People and Bulletproof proposition.
- **Decision:** disqualify as a standalone account. Preserve the parent proposition for a future
  enterprise-security experiment; do not address a message to the stale identity.
- **Source:** [current redirect](https://www.bulletproof.co.uk/)

### Bridewell

- **Observed:** large global provider focused on critical national infrastructure and enterprise
  managed security, with more than 300 employees and public turnover above £40m in company materials.
- **Decision:** disqualify from the current SME/mid-market wedge. Preserve for a future enterprise ICP
  test; this is not a diagnosis of its funnel.
- **Source:** [managed security](https://www.bridewell.com/managed-security)
